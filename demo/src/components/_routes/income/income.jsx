...
function Income() {
  ...
  return (
    <div className='p-2 sm:p-3'>
      <Outlet />
      <div>
        <h1 className='text-2xl sm:text-3xl font-bold mb-2 sm:mb-4'>My Income</h1>
      </div>
      <div>
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          <DialogTrigger asChild>
            <div
              className='flex flex-col bg-slate-100 p-6 sm:p-10 rounded-md items-center border-2 border-dashed cursor-pointer hover:shadow-md'>
              <h2 className='text-2xl sm:text-3xl'>+</h2>
              <h2 className='text-base sm:text-lg'>Enter New Income</h2>
            </div>
          </DialogTrigger>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                <div>
                  ...
                  <input
                    ...
                    className='border p-2 rounded-lg w-full mb-2 text-sm sm:text-base'
                  />
      ...
      <div className='mt-4'>
        <h2 className='text-lg sm:text-xl font-semibold mb-2'>Income List</h2>
